...
const Header = () => {
  ...
  return (
    <div className="flex justify-between items-center py-2 border shadow-lg  sticky top-0 bg-white">
      <Title />
      <div className="">
        <ul className="flex gap-2 md:gap-3 px-2 md:px-4 items-center text-sm md:text-md font-semibold text-gray-700">
          ...
          <li>
            ...
            {isLoggedin ? (
              <button
                className="border text-white px-4 py-2 bg-gray-500 rounded-md"
